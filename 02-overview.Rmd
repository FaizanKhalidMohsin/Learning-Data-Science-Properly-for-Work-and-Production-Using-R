...
1. Project management & Team Collaboration and Communication technologies.
    1. Slack
...
3. Statistical Computational Language R (in our case, but in general could be Python, Julia, etc.)
    1. R
    2. RStudio
    3. RMarkdown
4. Data Bases
    1. SQL
    2. SQLite
5. Applications and Interactive Dashboards in R.
    1. Flexdashboard
    2. Shiny
    3. Shinydashboards
6.  
