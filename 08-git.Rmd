...
1. **Tip Number 1:** When simultaneously working on two different projects, not even necessarily programming projects, then have two terminals or git bash terminals open each one cd'ed into the respective project's working directory. 
...
## Configure Username and Email on GitBash
Before working on Git you have to configure your username and email id on Git bash.

**Point 1** Open Git Bash 
**Point 2** Set your username: git config --global user.name "FIRST_NAME LAST_NAME"
**Point 3** Set your email address: git config --global user.email "MY_NAME@example.com"
